...
export function CanvasShowcase() {
  return (
    <>
      <div className="mx-auto flex w-full flex-col items-center justify-center gap-4 bg-white px-8 dark:bg-black lg:flex-row">
        <Card title="Music is Connection" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="Music is Love" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Music is You" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
